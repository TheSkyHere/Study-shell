...
echo "=========================== Upgrade master BIOS  Start===========================" >> $logfile
bios_upgrade master  -w ./AS14-40D-F.1.00.04.bin  >> $logfile
echo "=========================== Upgrade master BIOS  Over ===========================" >> $logfile
